...
> 基于 De-AI-Prompt-Enhancer 项目，专注于将 AI 生成的文章转化为**地道、流畅、富有吸引力**的人类写作风格。
...
✅ 风格匹配：优化后的风格需符合原文主题、目的和目标受众
✅ 自然为本：避免过度修饰或炫技，追求真诚、自然的表达
✅ 逻辑严谨：优化过程不能破坏原文的逻辑结构
✅ 杜绝新"AI 味"：严格遵守 Guidelines，确保彻底摆脱机器痕迹
```
...
【人味注入统计】
- 句式变化次数：N 处（长句拆短/插入动作/设问反问）
- 口语化表达：N 处（俗语/口头禅/非正式表达）
- 互动感营造：N 处（设问/直接称呼读者）
- 感官细节补充：N 处（视觉/听觉/触觉描写）
```
